<template>
  ...
  >
    <div
      ...
      :style="$q.platform.is.ios ? 'padding-bottom: 15px;' : ''"
    >
      <div>
        <q-btn
          color="brandblue"
...
export default defineComponent({
  ...
  setup() {
    ...
    function promptAmount() {
      ...
      const acceptedTokensData =
        walletStore.acceptedTokensData?.accepted_tokens;
...
.receive-page-btn {
  box-shadow: 0 4px 20px rgba(42, 79, 145, 0.4);
}
