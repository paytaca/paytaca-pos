...
<script>
import { defineComponent, computed, getCurrentInstance, inject, markRaw, onMounted, ref, watch } from 'vue';
import { useDialogPluginComponent } from 'quasar'

export default defineComponent({
  name: 'PinLocationDialog',
  props: {
    headerText: String,
    initLocation: Object,
    static: Boolean,
  ...
  setup(props) {
    ...
    watch(() => [props.static], () => {
      ...
      else map.value.on('move', () => updateCoordinates())
    })
