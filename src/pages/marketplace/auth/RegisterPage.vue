      ...
      backend.post('users/register/', data)
        ...
        .catch(error => {
          if (error?.response?.data) {
            ...
            errors.value.username = errorParser.firstElementOrValue(data?.username)
            errors.value.password = errorParser.firstElementOrValue(data?.password)
            errors.value.email = errorParser.firstElementOrValue(data?.email)
            errors.value.firstName = errorParser.firstElementOrValue(data?.first_name)
            errors.value.lastName = errorParser.firstElementOrValue(data?.last_name)
