...
export default {
  ...
  AddedQuantity: "Purchase order reviewed {quantity} by {STRING} (you)",
  ...
  ChangedTo: "Purchase order reviewed {quantity}",
  ChangedToFrom: "to {previousQuantity}",
  Chat: "Chat",
  Checkbox: "Checkbox",
  Checkout: "Checkout",
  ...
  DarkMode: "Dark Mode",
  Date: "Date",
  DateFrom: "Deleting collection '{from}'. Are you sure?",
  DateFromTo: "Remove {from} product(s) from storefront",
  DateTo: "Reviewed by {to} at {STRING}",
  DecodingContent: "Decoding content",
  DecryptingXpubkey: "Decrypting xpubkey",
  DeductedQuantity: "Purchase order reviewed {quantity} by {STRING}",
  ...
  DeleteProductPromptMsg: "{name} variants",
  ...
  Number: "Number",
  NumberOfStocks: "`. Try again after {count} seconds`",
  OK: "OK",
  OPEN: "OPEN",
  ...
  OrderDisputesCount: "{orderDisputesCount} - Addon Options",
  OrderId: "Order #{id}",
  ...
  PendingOrdersCount: "Removing {pendingOrdersCount} {STRING}. Are you sure?",
  ...
  PoNumber: "PO#{number}",
  PoNumberItems: "{number} order dispute(s)",
  ...
  ProductsCount: "Delete product '{productsCount}'. Are you sure?",
  ...
  PurchaseOrderCount: "{count} payment(s) in escrow",
  PurchaseOrderCreated: "Purchase Order created",
  PurchaseOrderHistory: "Purchase order history",
  PurchaseOrderNumber: "Purchase Order Number",
  PurchaseOrderReviewed: "Reviewed by {date} (you) at {STRING}",
  PurchaseOrderReviewedBy: "{date} to {name}",
  PurchaseOrderReviewedYou: "from {date}",
  ...
  Reviewed: "Reviewed",
  ReviewedBy: "{name} purchase order(s) assigned to you for review",
  ...
  Staff: "Staff",
  StaffCount: "Cost price {count} {STRING}",
  Status: "Status",
  ...
  Value: "Value",
  Variant: "Variant",
  VariantCount: "{count} pending purchase orders",
