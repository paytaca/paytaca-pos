...
export default {
  ...
  CopyAddressOrScanQR: "Copia l'indirizzo o scansiona il codice QR",
  ...
  CreatePaymentRequest: "Crea richiesta di pagamento",
  ...
  DefaultAsset: "Risorsa predefinita",
  ...
  EnterAmountToBeReceived: "Inserisci l'importo da ricevere",
  Equals: "Uguali",
  Error: "Errore",
  ErrorEncountered: "Si è verificato un errore",
  ErrorGeneratingAddress: "Errore durante la generazione dell'indirizzo",
  ...
  FailedToLoadTransaction: "Impossibile caricare la transazione",
  ...
  HideTransactions: "Nascondi transazioni",
  Home: "Casa",
  Hours: "Ore",
  ...
  PrintStaticQR: "Stampa QR statico",
  PrintStaticQRDesc: "Visualizza un codice QR per i pagamenti dei clienti in negozio",
  Private: "Privato",
  Proceed: "Procedi",
  Product: "Prodotto",
  ...
  PurchaseOrderReviewedBy: "Ordine di acquisto esaminato il giorno {date} da {name}",
  ...
  ReceivePayment: "Ricevi il pagamento",
  Received: "Ricevuto",
  ...
  Sales: "Vendite",
  SalesLast24h: "Vendite (ultime 24 ore)",
  ...
  ScanToPayWithBCH: "Scansiona per pagare con Bitcoin Cash",
  Search: "Cerca",
  ...
  ShowDebugTools: "Mostra strumenti di debug",
  ...
  TransactionIDIsRequired: "L'ID della transazione è obbligatorio",
  ...
  WalletNotInitialized: "Portafoglio non inizializzato",
  WalletNotReady: "Il portafoglio non è pronto",
  Yes: "Sì",
  Yesterday: "Ieri",
  add: "aggiungere",
  edit: "modifica",
