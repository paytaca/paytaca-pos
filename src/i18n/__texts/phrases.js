  ...
  static: [
    {
      ...
      Deleted: "Deleted",
      Device: "Device",
      EnterAmountToBeReceived: "Enter amount to be received",
      ...
      Resolve: "Resolve",
      ShowDebugTools: "Show Debug Tools",
      State: "State",
      Submit: "Submit",
      ...
      AdminPermissionErrMsg:
        "Sorry, you do not have sufficient admin permissions.",
    ...
    },
    {
      ...
      OrderCancelMsg:
        "Order will be cancelled after resolving dispute. Continue?",
    ...
    },
    {
      ...
      EncounteredErrorsInUpdatingStocks:
        "Encountered errors in updating stocks",
    ...
    },
    {
      ...
      RequireStockDesc:
        "The product will require stock availability when ordering",
  ...
  dynamic: [
    {
      ...
      PurchaseOrderCount:
        "{count} purchase order(s) assigned to you for review",
      ...
      PurchaseOrderReviewedYou:
        "Purchase order reviewed {date} by {name} (you)",
