...
export default {
  ...
  CopyAddressOrScanQR: "Kopieer het adres of scan de QR-code",
  ...
  CreatePaymentRequest: "Betaalverzoek aanmaken",
  ...
  EnterAmountToBeReceived: "Voer het te ontvangen bedrag in",
  Equals: "Gelijk aan",
  Error: "Fout",
  ErrorEncountered: "Er is een fout opgetreden",
  ErrorGeneratingAddress: "Fout bij genereren van adres",
  ErrorSavingImage: "Fout bij opslaan van afbeelding",
  Escrow: "Borg",
  Expected: "Verwacht",
  ...
  FailedToLoadTransaction: "Kan transactie niet laden",
  ...
  HideTransactions: "Transacties verbergen",
  Home: "Thuis",
  Hours: "Uur",
  ImageSaved: "Afbeelding succesvol opgeslagen",
  InMeters: "in meter",
  InStock: "Op voorraad",
  ...
  PrintStaticQR: "Statische QR afdrukken",
  PrintStaticQRDesc: "Geef een QR-code weer voor klantbetalingen in de winkel",
  Private: "Privé",
  Proceed: "Ga verder",
  Product: "Product",
  ...
  ScanToPayWithBCH: "Scannen om te betalen met Bitcoin Cash",
  Search: "Zoeken",
  ...
  ShowDebugTools: "Foutopsporingstools tonen",
  ShowMore: "Laat meer zien",
  ShowSummary: "Samenvatting weergeven",
  ShowTransactions: "Transacties tonen",
  SignIn: "Sign-in",
  SoNumber: "SO#{number}",
  ...
  TransactionIDIsRequired: "Transactie-ID is vereist",
  ...
  WalletNotInitialized: "Portemonnee niet geïnitialiseerd",
  WalletNotReady: "Portemonnee is niet klaar",
  Yes: "Ja",
  Yesterday: "Gisteren",
  add: "toevoegen",
  edit: "bewerken",
